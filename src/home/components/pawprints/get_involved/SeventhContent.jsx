...
const SeventhContent = () => {
  return (
    <div className=" bg-white xl:mb-[52px]">
      <div className="flex xl:flex-row flex-col items-center xl:justify-center justify-between xl:mx-[250px] xl:gap-[24px] p-5 xl:pb-0 pb-28 gap-5 rounded-lg relative bg-[#8B4513] overflow-hidden ">
        ...
        <div className="flex flex-col xl:w-[850px] w-full items-center justify-center xl:py-[56px] xl:gap-[24px] gap-4 text-white  ">
