...
const PawCards =({items, index}) => {
    ...
    return(
        <div className="flex flex-col xl:w-[452px] w-[300px] rounded-xl shadow-lg bg-white">
            <div>
                
                <img src={items.img} className="xl:h-[302px] h-[200px] xl:w-[452px] w-[300px] rounded-t-xl" />
            </div>
